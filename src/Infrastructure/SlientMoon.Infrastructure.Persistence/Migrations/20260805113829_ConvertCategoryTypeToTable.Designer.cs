...
namespace SlientMoon.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260805113829_ConvertCategoryTypeToTable")]
    partial class ConvertCategoryTypeToTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SlientMoon.Domain.Entities.Topic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ColorHex = "#8E97FD",
                            CreatedAt = new DateTime(2026, 8, 5, 11, 38, 28, 948, DateTimeKind.Utc).AddTicks(937),
                            IconKey = "leaf",
                            Slug = "reduce-stress",
                            Title = "Reduce Stress"
                        },
                        new
                        {
                            ...
                            ColorHex = "#FFC97E",
                            CreatedAt = new DateTime(2026, 8, 5, 11, 38, 28, 948, DateTimeKind.Utc).AddTicks(946),
                            IconKey = "moon",
                            Slug = "improve-sleep",
                            Title = "Improve Sleep"
                        });
